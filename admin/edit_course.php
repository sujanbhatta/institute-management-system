...
if(isset($_REQUEST['submit']))
{
  ...
  if($updatecourse)
  {
  $msg="Course Details Successfully Updated";
  }
  else
  {
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <h2 class="page-title">Update Course</h2>
...
<?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
      ...
      <?php 
$getall=$course->GetAllCourseById($id);
if($getall){
...
<div class="col-sm-4">
<input type="text" name="coursename" class="form-control" value="<?php echo $result['coursename'];?>" required>
</div>
</div>
<div class="form-group">
<label class="col-sm-2 control-label">Tutor<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="tutor" class="form-control" value="<?php echo $result['tutor'];?>" required>
</div>
</div>
<div class="form-group">
<label class="col-sm-2 control-label">About Course<span style="color:red">*</span></label>
<div class="col-sm-4">
<textarea rows="3" cols="20" class="form-control" name="description"><?php echo $result['about']; ?> </textarea>
</div>
</div>
<div class="form-group">
...
<div class="col-sm-4">
<input type="text" name="duration" class="form-control" value="<?php echo $result['duration'];?>" required>
</div>
</div>
