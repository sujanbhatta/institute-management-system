...
if(isset($_REQUEST['submit']))
{
  ...
  $addevent=$event->CreateEvents($_POST,$_FILES);
  if($addevent)
  {
  $msg="Events Details Successfully Added";
  }
  else
  {
  $error="Error !! In Adding Events Details";
  }
}
?>
<!doctype html>
...
<div class="col-sm-4">
<textarea rows="3" cols="20" class="form-control" name="description"> </textarea>
</div>
</div>
...
Image  <span style="color:red">*</span><input type="file" name="image" required>
              ...
              <input type="submit" name="submit" class="btn btn-primary" value="Add Events"><hr>
              </div>
              </div>
