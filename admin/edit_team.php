...
if(isset($_REQUEST['submit']))
{
  ...
  $updateteam=$team->UpdateTeam($_POST,$_FILES,$id);
  if($updateteam)
  {
  $msg="Team Details Successfully Updated";
  }
  else
  {
  $error="Error !! In Updating Team Details";
  }
}
?>
<!doctype html>
...
<div class="col-sm-4">
<input type="text" name="about" class="form-control" value="<?php echo $result['about'];?>" required>
</div>
</div>
