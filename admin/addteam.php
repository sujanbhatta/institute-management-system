...
if(isset($_REQUEST['submit']))
{
  ...
  $addteam=$team->CreateTeam($_POST,$_FILES);
  if($addteam)
  {
  $msg="Team Details Successfully Added";
  }
  else
  {
  $error="Error !! In Adding Team Details";
  }
}
?>
<!doctype html>
...
Image  <span style="color:red">*</span><input type="file" name="image" required>
              ...
              <input type="submit" name="submit" class="btn btn-primary" value="Add Team"><hr>
              </div>
              </div>
